...
## NOTE: There are tests for this project,
# but the tests are NOT exhaustive --
# you should pass them, but ONLY passing them is not necessarily sufficient to get 100% on the project.
...
#  from a specific Twitter user's timeline, and uses caching.
# The function should return a Python object representing the data that was retrieved from Twitter.
# (This may sound familiar...) We have provided a CACHE_FNAME variable for you for the cache file name,
# but you must write the rest of the code in this file.
...
# Note that running the tests will actually create this file for you,
#  but will not do anything else to it like create any tables; you should still start it in exactly the same way as if the tests did not do that!
